...
public class WebConstants {
	...
	public static String apiUser = PropertyFileReader.getValue("api_user");
	public static String apiPassword = PropertyFileReader.getValue("api_password");
	...
	public static final String contentImageDirectory=PropertyFileReader.getValue("contentImageDirectory");
	public static final String schoolImageDirectory=PropertyFileReader.getValue("schoolImageDirectory");
}
